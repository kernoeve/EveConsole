...
public static class PostgresSchema
{
    ...
    [
        ...
        """,
        // The store web channel: what the app has told a site about each order, and everything
        // a site has sent back. Entities that arrived after databases existed.
        """
        CREATE TABLE IF NOT EXISTS "StoreWebPushes" (
        ...
        """,
        """
        CREATE TABLE IF NOT EXISTS "StoreWebEvents" (
            "Id"         INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            "StoreId"    INTEGER     NOT NULL DEFAULT 0,
            "Seq"        BIGINT      NOT NULL DEFAULT 0,
            "Kind"       TEXT        NOT NULL DEFAULT '',
            "WebOrderId" TEXT        NOT NULL DEFAULT '',
            "BuyerId"    BIGINT      NOT NULL DEFAULT 0,
        ...
        // The store's web channel. Every column has a default, so an older build's rows and
        // reads are untouched.
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebEnabled" BOOLEAN NOT NULL DEFAULT FALSE
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebUrl" TEXT NOT NULL DEFAULT ''
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebSecret" TEXT NOT NULL DEFAULT ''
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebTheme" TEXT NOT NULL DEFAULT 'dark'
        """,
        """
        ...
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebCursor" BIGINT NOT NULL DEFAULT 0
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebGeneration" TEXT NOT NULL DEFAULT ''
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebSiteVersion" TEXT NOT NULL DEFAULT ''
        """,
        """
        ALTER TABLE "Stores" ADD COLUMN IF NOT EXISTS "WebLastSyncAt" TIMESTAMPTZ NULL
        """,
        """
